...
class DoorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create door" do
    assert_difference('Door.count') do
      post doors_url, params: { door: { description: @door.description, is_open: @door.is_open, name: @door.name } }
    end
  ...
  test "should update door" do
    patch door_url(@door), params: { door: { description: @door.description, is_open: @door.is_open, name: @door.name } }
